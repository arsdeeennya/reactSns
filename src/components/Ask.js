...
const Ask = ({ ask, prof }) => {
  ...
  const sendDM = () => {
    ...
    uploadDM.append("receiver", ask.askFrom);	//送ってきた人
    uploadDM.append("message", text);	
    sendDMCont(uploadDM);
    setModalIsOpen(false); // 送ったらmodalclose
  };
  ...
  return (
    <li className="list-item">
      ...
      <Modal
        isOpen={modalIsOpen} // true or false
        onRequestClose={() => setModalIsOpen(false)} // 余白クリックでcloseできる
        style={customStyles}
      >
